...
class InitialBidingRateMustBePositive(val clientId: ClientId, val initialBidingRate: Tokens)
    : DomainObjectInvalidUsed("Client with id: ${clientId.value} can't reserve table with initial biding rate: ${initialBidingRate.count} because initial biding rate must be positive") {
